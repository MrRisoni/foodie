 ...
 * Shops
 *
 * @ORM\Table(name="shops", indexes={@ORM\Index(name="index_shops_on_restaurants_id", columns={"restaurants_id"}), @ORM\Index(name="index_shops_on_suburbs_id", columns={"suburbs_id"})})
 * @ORM\Entity
 */
class Shops
{
